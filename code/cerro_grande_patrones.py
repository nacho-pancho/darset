...
if __name__ == '__main__':
    ...
    nom_series_p1 = ['velGEN_5','cosdirGEN_5','sindirGEN_5']
    ...
    meds_plot_p1 = [vel_GEN_5, vel_scada_5, dir_scada_5, dir_pronos_5]
    ...
    nom_series_p2 = ['cosdirPRONOS_7','sindirPRONOS_7','potSCADA_7']
    ...
    meds_plot_p2 = [vel_PRONOS_7, vel_GEN_7, vel_SCADA_7, dir_PRONOS_7, parque2.pot,
                    parque2.cgm]
