...
if __name__ == '__main__':
    ...
    vel_GEN_p1 = parque1.medidores[0].get_medida('vel','scada')
    dir_GEN_p1 = parque1.medidores[0].get_medida('dir','scada')
    ...
    tini = datetime.datetime(2020, 11, 1)  
    tfin = datetime.datetime(2020, 12, 1)
