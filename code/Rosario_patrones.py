...
if __name__ == '__main__':
    ...
    # Artilleros   
    parque1 = archivos.leerArchivosCentral(36)
    parque1.registrar() 
    ...
    nom_series_p1 = ['velxGEN_36','velyGEN_36']
    ...
    # Ventus1
    parque2 = archivos.leerArchivosCentral(10)
    parque2.registrar()
    ...
    nom_series_p2 = ['velxPRONOS_10', 'velyPRONOS_10', 'potSCADA_10']
